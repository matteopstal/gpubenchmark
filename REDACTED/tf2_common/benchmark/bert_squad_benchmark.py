...
from REDACTED.tf2_common.benchmark import bert_benchmark_utils as benchmark_utils
from REDACTED.tf2_common.benchmark import squad_evaluate_v1_1
from REDACTED.tf2_bert.bert import run_squad
from REDACTED.tf2_common.utils.misc import distribution_utils
from REDACTED.tf2_common.utils.misc import keras_utils
from REDACTED.tf2_common.utils.testing import benchmark_wrappers
...
SQUAD_TRAIN_DATA_PATH = '/placer/prod/home/tensorflow-performance-data/datasets/bert/squad/squad_train.tf_record'
SQUAD_PREDICT_FILE = '/placer/prod/home/tensorflow-performance-data/datasets/bert/squad/dev-v1.1.json'
...
SQUAD_MEDIUM_INPUT_META_DATA_PATH = '/placer/prod/home/tensorflow-performance-data/datasets/bert/squad/squad_medium_meta_data'
SQUAD_LONG_INPUT_META_DATA_PATH = '/placer/prod/home/tensorflow-performance-data/datasets/bert/squad/squad_long_meta_data'
SQUAD_FULL_INPUT_META_DATA_PATH = '/placer/prod/home/tensorflow-performance-data/datasets/bert/squad/squad_full_meta_data'
