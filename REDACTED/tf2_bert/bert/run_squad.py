...
#from REDACTED.tf2_bert.albert import configs as albert_configs
...
from REDACTED.tf2_bert.data import squad_lib as squad_lib_wp
# sentence-piece tokenizer based squad_lib
from REDACTED.tf2_bert.data import squad_lib_sp
...
def predict_squad(strategy, input_meta_data):
  ...
  #nnigania: check the below lines, 
