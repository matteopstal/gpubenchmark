...
class LAMBOptimizer(optimizer_v2.OptimizerV2):
  ...
  def _resource_apply_dense_kernel(self, grad, var, apply_state=None):
  ...
  def _resource_apply_dense_kernel_compile(self,
                                           grad,
                                           var,
                                           var_id,
                                           apply_state=None):
    return self._resource_apply_dense_kernel(grad, var, apply_state)

  def _resource_apply_dense(self, grad, var, apply_state=None):
    if self.use_experimental_compile:
      var_update = self._resource_apply_dense_kernel_compile(
          grad, var, id(var), apply_state)
    else:
      var_update = self._resource_apply_dense_kernel(grad, var, apply_state)
